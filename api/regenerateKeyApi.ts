...
export enum RegenerateKeyApiApiKeys {
    tokenAuth,
}

export class RegenerateKeyApi {
    ...
    public setApiKey(key: RegenerateKeyApiApiKeys, value: string) {
        (this.authentications as any)[RegenerateKeyApiApiKeys[key]].apiKey = value;
    }
    ...
    public async regenerateKeyCreate (remoteKeyForRegenerationRequest: RemoteKeyForRegenerationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RemoteKey;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RemoteKey;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "RemoteKey");
