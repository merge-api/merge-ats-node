...
export class SyncStatusApi {
     ...
     */
    public async syncStatusRetrieve (xAccountToken: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SyncStatus;  }> {
        ...
        if (xAccountToken === null || xAccountToken === undefined) {
            throw new Error('Required parameter xAccountToken was null or undefined when calling syncStatusRetrieve.');
        }
