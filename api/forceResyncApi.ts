...
export enum ForceResyncApiApiKeys {
    tokenAuth,
}

export class ForceResyncApi {
    ...
    public setApiKey(key: ForceResyncApiApiKeys, value: string) {
        (this.authentications as any)[ForceResyncApiApiKeys[key]].apiKey = value;
    }
