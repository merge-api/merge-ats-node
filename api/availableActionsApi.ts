...
export class AvailableActionsApi {
    ...
    public setApiKey(key: AvailableActionsApiApiKeys, value: string) {
    ...
    public async availableActionsRetrieve (xAccountToken: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AvailableActions;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AvailableActions;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AvailableActions");
