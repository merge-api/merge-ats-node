...
export enum GenerateKeyApiApiKeys {
    tokenAuth,
}

export class GenerateKeyApi {
    ...
    public setApiKey(key: GenerateKeyApiApiKeys, value: string) {
        (this.authentications as any)[GenerateKeyApiApiKeys[key]].apiKey = value;
    }
