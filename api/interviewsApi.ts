...
export enum InterviewsApiApiKeys {
    tokenAuth,
}
...
export class InterviewsApi {
    ...
    public setApiKey(key: InterviewsApiApiKeys, value: string) {
        (this.authentications as any)[InterviewsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param scheduledInterviewRequest 
     */
    public async interviewsCreate (xAccountToken: string, remoteUserId: string, runAsync?: boolean, scheduledInterviewRequest?: ScheduledInterviewRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ScheduledInterview;  }> {
        ...
        if (remoteUserId === null || remoteUserId === undefined) {
            throw new Error('Required parameter remoteUserId was null or undefined when calling interviewsCreate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(scheduledInterviewRequest, "ScheduledInterviewRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ScheduledInterview;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ScheduledInterview");
    ...
    public async interviewsList (xAccountToken: string, applicationId?: string, createdAfter?: Date, createdBefore?: Date, cursor?: string, expand?: 'application' | 'application,job_interview_stage' | 'interviewers' | 'interviewers,application' | 'interviewers,application,job_interview_stage' | 'interviewers,job_interview_stage' | 'interviewers,organizer' | 'interviewers,organizer,application' | 'interviewers,organizer,application,job_interview_stage' | 'interviewers,organizer,job_interview_stage' | 'job_interview_stage' | 'organizer' | 'organizer,application' | 'organizer,application,job_interview_stage' | 'organizer,job_interview_stage', includeRemoteData?: boolean, jobInterviewStageId?: string, modifiedAfter?: Date, modifiedBefore?: Date, organizerId?: string, pageSize?: number, remoteId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaginatedScheduledInterviewList;  }> {
        ...
        if (expand !== undefined) {
            localVarQueryParameters['expand'] = ObjectSerializer.serialize(expand, "'application' | 'application,job_interview_stage' | 'interviewers' | 'interviewers,application' | 'interviewers,application,job_interview_stage' | 'interviewers,job_interview_stage' | 'interviewers,organizer' | 'interviewers,organizer,application' | 'interviewers,organizer,application,job_interview_stage' | 'interviewers,organizer,job_interview_stage' | 'job_interview_stage' | 'organizer' | 'organizer,application' | 'organizer,application,job_interview_stage' | 'organizer,job_interview_stage'");
        }
        ...
        if (jobInterviewStageId !== undefined) {
            localVarQueryParameters['job_interview_stage_id'] = ObjectSerializer.serialize(jobInterviewStageId, "string");
        }
        ...
        if (organizerId !== undefined) {
            localVarQueryParameters['organizer_id'] = ObjectSerializer.serialize(organizerId, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PaginatedScheduledInterviewList;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PaginatedScheduledInterviewList");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
