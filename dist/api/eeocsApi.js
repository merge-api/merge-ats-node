...
exports.EeocsApi = exports.EeocsApiApiKeys = void 0;
...
var EeocsApiApiKeys;
(function (EeocsApiApiKeys) {
    EeocsApiApiKeys[EeocsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(EeocsApiApiKeys = exports.EeocsApiApiKeys || (exports.EeocsApiApiKeys = {}));
var EeocsApi = (function () {
    function EeocsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(EeocsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(EeocsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(EeocsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    EeocsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    EeocsApi.prototype.setApiKey = function (key, value) {
        this.authentications[EeocsApiApiKeys[key]].apiKey = value;
    };
    EeocsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    EeocsApi.prototype.eeocsList = function (xAccountToken, candidateId, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/eeocs';
                ...
                if (candidateId !== undefined) {
                    localVarQueryParameters['candidate_id'] = models_1.ObjectSerializer.serialize(candidateId, "string");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedEEOCList");
    ...
    EeocsApi.prototype.eeocsRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/eeocs/{id}'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "EEOC");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
...
exports.EeocsApi = EeocsApi;
//# sourceMappingURL=eeocsApi.js.map