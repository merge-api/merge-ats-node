...
var PassthroughApiApiKeys;
(function (PassthroughApiApiKeys) {
    PassthroughApiApiKeys[PassthroughApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(PassthroughApiApiKeys = exports.PassthroughApiApiKeys || (exports.PassthroughApiApiKeys = {}));
var PassthroughApi = (function () {
    function PassthroughApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PassthroughApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    PassthroughApi.prototype.setApiKey = function (key, value) {
        this.authentications[PassthroughApiApiKeys[key]].apiKey = value;
    };
    ...
    PassthroughApi.prototype.passthroughCreate = function (xAccountToken, dataPassthroughRequest, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/passthrough';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "RemoteResponse");
...
//# sourceMappingURL=passthroughApi.js.map