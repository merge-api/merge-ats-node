...
exports.AccountTokenApi = exports.AccountTokenApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var AccountTokenApiApiKeys;
(function (AccountTokenApiApiKeys) {
    AccountTokenApiApiKeys[AccountTokenApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(AccountTokenApiApiKeys = exports.AccountTokenApiApiKeys || (exports.AccountTokenApiApiKeys = {}));
var AccountTokenApi = (function () {
    function AccountTokenApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AccountTokenApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AccountTokenApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AccountTokenApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AccountTokenApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AccountTokenApi.prototype.setApiKey = function (key, value) {
        this.authentications[AccountTokenApiApiKeys[key]].apiKey = value;
    };
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "AccountToken");
...
//# sourceMappingURL=accountTokenApi.js.map