...
exports.AvailableActionsApi = exports.AvailableActionsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var AvailableActionsApiApiKeys;
(function (AvailableActionsApiApiKeys) {
    AvailableActionsApiApiKeys[AvailableActionsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(AvailableActionsApiApiKeys = exports.AvailableActionsApiApiKeys || (exports.AvailableActionsApiApiKeys = {}));
var AvailableActionsApi = (function () {
    function AvailableActionsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AvailableActionsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AvailableActionsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AvailableActionsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AvailableActionsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AvailableActionsApi.prototype.setApiKey = function (key, value) {
        this.authentications[AvailableActionsApiApiKeys[key]].apiKey = value;
    };
    ...
    AvailableActionsApi.prototype.availableActionsRetrieve = function (xAccountToken, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/available-actions';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "AvailableActions");
...
exports.AvailableActionsApi = AvailableActionsApi;
//# sourceMappingURL=availableActionsApi.js.map