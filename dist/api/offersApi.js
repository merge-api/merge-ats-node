...
exports.OffersApi = exports.OffersApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var OffersApiApiKeys;
(function (OffersApiApiKeys) {
    OffersApiApiKeys[OffersApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(OffersApiApiKeys = exports.OffersApiApiKeys || (exports.OffersApiApiKeys = {}));
var OffersApi = (function () {
    function OffersApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(OffersApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(OffersApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(OffersApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    OffersApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    OffersApi.prototype.setApiKey = function (key, value) {
        this.authentications[OffersApiApiKeys[key]].apiKey = value;
    };
    OffersApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    OffersApi.prototype.offersList = function (xAccountToken, applicationId, createdAfter, createdBefore, creatorId, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/offers';
                ...
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling offersList.');
                }
                ...
                if (creatorId !== undefined) {
                    localVarQueryParameters['creator_id'] = models_1.ObjectSerializer.serialize(creatorId, "string");
                }
                if (cursor !== undefined) {
                    localVarQueryParameters['cursor'] = models_1.ObjectSerializer.serialize(cursor, "string");
                }
                if (expand !== undefined) {
                    localVarQueryParameters['expand'] = models_1.ObjectSerializer.serialize(expand, "'application' | 'application,creator' | 'creator'");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedOfferList");
    ...
    OffersApi.prototype.offersRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/offers/{id}'
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling offersRetrieve.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling offersRetrieve.');
                }
                if (expand !== undefined) {
                    localVarQueryParameters['expand'] = models_1.ObjectSerializer.serialize(expand, "'application' | 'application,creator' | 'creator'");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Offer");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
