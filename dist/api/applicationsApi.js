...
(function (ApplicationsApiApiKeys) {
    ApplicationsApiApiKeys[ApplicationsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(ApplicationsApiApiKeys = exports.ApplicationsApiApiKeys || (exports.ApplicationsApiApiKeys = {}));
var ApplicationsApi = (function () {
    function ApplicationsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ApplicationsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ApplicationsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(ApplicationsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    ApplicationsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ApplicationsApi.prototype.setApiKey = function (key, value) {
    ...
    ApplicationsApi.prototype.applicationsCreate = function (xAccountToken, remoteUserId, runAsync, applicationRequest, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/applications';
    ...
    ApplicationsApi.prototype.applicationsList = function (xAccountToken, candidateId, createdAfter, createdBefore, creditedToId, currentStageId, cursor, expand, includeRemoteData, jobId, modifiedAfter, modifiedBefore, pageSize, rejectReasonId, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (creditedToId !== undefined) {
                    localVarQueryParameters['credited_to_id'] = models_1.ObjectSerializer.serialize(creditedToId, "string");
                }
                if (currentStageId !== undefined) {
                    localVarQueryParameters['current_stage_id'] = models_1.ObjectSerializer.serialize(currentStageId, "string");
                }
                if (cursor !== undefined) {
                ...
                if (rejectReasonId !== undefined) {
                    localVarQueryParameters['reject_reason_id'] = models_1.ObjectSerializer.serialize(rejectReasonId, "string");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedApplicationList");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    ApplicationsApi.prototype.applicationsRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/applications/{id}'
