...
exports.DepartmentsApi = exports.DepartmentsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var DepartmentsApiApiKeys;
(function (DepartmentsApiApiKeys) {
    DepartmentsApiApiKeys[DepartmentsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(DepartmentsApiApiKeys = exports.DepartmentsApiApiKeys || (exports.DepartmentsApiApiKeys = {}));
var DepartmentsApi = (function () {
    function DepartmentsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(DepartmentsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(DepartmentsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(DepartmentsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    DepartmentsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    DepartmentsApi.prototype.setApiKey = function (key, value) {
        this.authentications[DepartmentsApiApiKeys[key]].apiKey = value;
    };
    DepartmentsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    DepartmentsApi.prototype.departmentsList = function (xAccountToken, createdAfter, createdBefore, cursor, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/departments';
                ...
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling departmentsList.');
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedDepartmentList");
    ...
    DepartmentsApi.prototype.departmentsRetrieve = function (xAccountToken, id, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/departments/{id}'
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling departmentsRetrieve.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling departmentsRetrieve.');
                }
                if (includeRemoteData !== undefined) {
                    localVarQueryParameters['include_remote_data'] = models_1.ObjectSerializer.serialize(includeRemoteData, "boolean");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Department");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
...
//# sourceMappingURL=departmentsApi.js.map