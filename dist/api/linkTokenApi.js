...
exports.LinkTokenApi = exports.LinkTokenApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var LinkTokenApiApiKeys;
(function (LinkTokenApiApiKeys) {
    LinkTokenApiApiKeys[LinkTokenApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(LinkTokenApiApiKeys = exports.LinkTokenApiApiKeys || (exports.LinkTokenApiApiKeys = {}));
var LinkTokenApi = (function () {
    function LinkTokenApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(LinkTokenApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(LinkTokenApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(LinkTokenApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    LinkTokenApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    LinkTokenApi.prototype.setApiKey = function (key, value) {
        this.authentications[LinkTokenApiApiKeys[key]].apiKey = value;
    };
    ...
    LinkTokenApi.prototype.linkTokenCreate = function (endUserDetailsRequest, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/link-token';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "LinkToken");
...
exports.LinkTokenApi = LinkTokenApi;
//# sourceMappingURL=linkTokenApi.js.map