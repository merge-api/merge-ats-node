...
var LinkedAccountsApi = (function () {
    function LinkedAccountsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(LinkedAccountsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(LinkedAccountsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(LinkedAccountsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    LinkedAccountsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    LinkedAccountsApi.prototype.setApiKey = function (key, value) {
        this.authentications[LinkedAccountsApiApiKeys[key]].apiKey = value;
    };
    LinkedAccountsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    LinkedAccountsApi.prototype.linkedAccountsList = function (category, cursor, endUserEmailAddress, endUserOrganizationName, endUserOriginId, endUserOriginIds, id, ids, integrationName, isTestAccount, pageSize, status, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/linked-accounts';
