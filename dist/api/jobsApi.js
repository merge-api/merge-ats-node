...
exports.JobsApi = exports.JobsApiApiKeys = void 0;
...
var JobsApiApiKeys;
(function (JobsApiApiKeys) {
    JobsApiApiKeys[JobsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(JobsApiApiKeys = exports.JobsApiApiKeys || (exports.JobsApiApiKeys = {}));
var JobsApi = (function () {
    function JobsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(JobsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(JobsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(JobsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    JobsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    JobsApi.prototype.setApiKey = function (key, value) {
        this.authentications[JobsApiApiKeys[key]].apiKey = value;
    };
    JobsApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    JobsApi.prototype.jobsList = function (xAccountToken, code, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/jobs';
                ...
                if (expand !== undefined) {
                    localVarQueryParameters['expand'] = models_1.ObjectSerializer.serialize(expand, "'departments' | 'departments,hiring_managers' | 'departments,offices' | 'departments,offices,hiring_managers' | 'hiring_managers' | 'offices' | 'offices,hiring_managers'");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedJobList");
    ...
    JobsApi.prototype.jobsRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/jobs/{id}'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Job");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
