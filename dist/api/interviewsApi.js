...
exports.InterviewsApi = exports.InterviewsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var InterviewsApiApiKeys;
(function (InterviewsApiApiKeys) {
    InterviewsApiApiKeys[InterviewsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(InterviewsApiApiKeys = exports.InterviewsApiApiKeys || (exports.InterviewsApiApiKeys = {}));
var InterviewsApi = (function () {
    function InterviewsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(InterviewsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(InterviewsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(InterviewsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    InterviewsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    InterviewsApi.prototype.setApiKey = function (key, value) {
        this.authentications[InterviewsApiApiKeys[key]].apiKey = value;
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling interviewsList.');
                }
                ...
                if (organizerId !== undefined) {
                    localVarQueryParameters['organizer_id'] = models_1.ObjectSerializer.serialize(organizerId, "string");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedScheduledInterviewList");
    ...
    InterviewsApi.prototype.interviewsRetrieve = function (xAccountToken, id, expand, includeRemoteData, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling interviewsRetrieve.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling interviewsRetrieve.');
                }
                if (expand !== undefined) {
                    localVarQueryParameters['expand'] = models_1.ObjectSerializer.serialize(expand, "'application' | 'application,job_interview_stage' | 'interviewers' | 'interviewers,application' | 'interviewers,application,job_interview_stage' | 'interviewers,job_interview_stage' | 'interviewers,organizer' | 'interviewers,organizer,application' | 'interviewers,organizer,application,job_interview_stage' | 'interviewers,organizer,job_interview_stage' | 'job_interview_stage' | 'organizer' | 'organizer,application' | 'organizer,application,job_interview_stage' | 'organizer,job_interview_stage'");
                }
...
exports.InterviewsApi = InterviewsApi;
//# sourceMappingURL=interviewsApi.js.map