...
exports.RegenerateKeyApi = exports.RegenerateKeyApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var RegenerateKeyApiApiKeys;
(function (RegenerateKeyApiApiKeys) {
    RegenerateKeyApiApiKeys[RegenerateKeyApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(RegenerateKeyApiApiKeys = exports.RegenerateKeyApiApiKeys || (exports.RegenerateKeyApiApiKeys = {}));
var RegenerateKeyApi = (function () {
    function RegenerateKeyApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(RegenerateKeyApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(RegenerateKeyApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(RegenerateKeyApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    RegenerateKeyApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    RegenerateKeyApi.prototype.setApiKey = function (key, value) {
        this.authentications[RegenerateKeyApiApiKeys[key]].apiKey = value;
    };
    ...
    RegenerateKeyApi.prototype.regenerateKeyCreate = function (remoteKeyForRegenerationRequest, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/regenerate-key';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "RemoteKey");
...
exports.RegenerateKeyApi = RegenerateKeyApi;
//# sourceMappingURL=regenerateKeyApi.js.map