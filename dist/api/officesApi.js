...
exports.OfficesApi = exports.OfficesApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var OfficesApiApiKeys;
(function (OfficesApiApiKeys) {
    OfficesApiApiKeys[OfficesApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(OfficesApiApiKeys = exports.OfficesApiApiKeys || (exports.OfficesApiApiKeys = {}));
var OfficesApi = (function () {
    function OfficesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(OfficesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(OfficesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(OfficesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    OfficesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    OfficesApi.prototype.setApiKey = function (key, value) {
        this.authentications[OfficesApiApiKeys[key]].apiKey = value;
    };
    OfficesApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    OfficesApi.prototype.officesList = function (xAccountToken, createdAfter, createdBefore, cursor, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/offices';
                ...
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling officesList.');
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedOfficeList");
    ...
    OfficesApi.prototype.officesRetrieve = function (xAccountToken, id, includeRemoteData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/offices/{id}'
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling officesRetrieve.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling officesRetrieve.');
                }
                if (includeRemoteData !== undefined) {
                    localVarQueryParameters['include_remote_data'] = models_1.ObjectSerializer.serialize(includeRemoteData, "boolean");
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Office");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
...
//# sourceMappingURL=officesApi.js.map