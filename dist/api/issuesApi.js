...
var IssuesApi = (function () {
    function IssuesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(IssuesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(IssuesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(IssuesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    IssuesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    IssuesApi.prototype.setApiKey = function (key, value) {
    ...
    IssuesApi.prototype.issuesList = function (accountToken, cursor, endDate, endUserOrganizationName, includeMuted, integrationName, pageSize, startDate, status, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/issues';
    ...
    IssuesApi.prototype.issuesRetrieve = function (id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/issues/{id}'
