...
exports.AttachmentsApi = exports.AttachmentsApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.merge.dev/api/ats/v1';
var AttachmentsApiApiKeys;
(function (AttachmentsApiApiKeys) {
    AttachmentsApiApiKeys[AttachmentsApiApiKeys["tokenAuth"] = 0] = "tokenAuth";
})(AttachmentsApiApiKeys = exports.AttachmentsApiApiKeys || (exports.AttachmentsApiApiKeys = {}));
var AttachmentsApi = (function () {
    function AttachmentsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AttachmentsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AttachmentsApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AttachmentsApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AttachmentsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AttachmentsApi.prototype.setApiKey = function (key, value) {
        this.authentications[AttachmentsApiApiKeys[key]].apiKey = value;
    };
    ...
    AttachmentsApi.prototype.attachmentsCreate = function (xAccountToken, remoteUserId, runAsync, attachmentRequest, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/attachments';
    ...
    AttachmentsApi.prototype.attachmentsList = function (xAccountToken, candidateId, createdAfter, createdBefore, cursor, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling attachmentsList.');
                }
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "PaginatedAttachmentList");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    AttachmentsApi.prototype.attachmentsRetrieve = function (xAccountToken, id, includeRemoteData, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/attachments/{id}'
                ...
                localVarFormParams = {};
                if (xAccountToken === null || xAccountToken === undefined) {
                    throw new Error('Required parameter xAccountToken was null or undefined when calling attachmentsRetrieve.');
                }
...
//# sourceMappingURL=attachmentsApi.js.map